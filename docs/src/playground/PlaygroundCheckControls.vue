<script lang="ts" setup>
	...
	import GCheckboxGroup from '@/components/ui/GCheckboxGroup/GCheckboxGroup.vue';
	import GRadio from '@/components/ui/GRadio/GRadio.vue';
	import GSwitch from '@/components/ui/GSwitch/GSwitch.vue';
	import GSquircle from '@/components/ui/GSquircle/GSquircle.vue';
