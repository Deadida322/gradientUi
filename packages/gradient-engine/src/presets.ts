...
export const gradientPresets = defineGradientPresetRegistry({
	materialBorder: defineGradientPreset({
		label: 'Material border',
		description: 'Default Gradient UI border material.',
		gradient: {
			recipe: 'glare',
			type: 'linear',
			direction: 135
	...
	materialAction: defineGradientPreset({
		label: 'Material action',
		description: 'Compact action material for buttons, chips and controls.',
		gradient: {
			recipe: 'glare',
			type: 'linear',
			direction: 135
	...
	materialSurface: defineGradientPreset({
		label: 'Material surface',
		description: 'Soft surface material for calm gradient backgrounds.',
		gradient: {
			recipe: 'monochrome',
			type: 'linear',
			direction: 145
